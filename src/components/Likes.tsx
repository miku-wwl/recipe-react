...
import { GetUserLikeRequest, LikeItemWithOwner, Like, MediaItemWithOwner, PostLikeRequest } from "../types/DBTypes";
...
const Likes = (props: {recipeItem: MediaItemWithOwner}) => {
  ...
  const {postLike, deleteLike, getCountByMediaId, getUserLike, getLikeListWithOwner} = useLike();
  ...
  return (
    <div className=" mb-5 text-xl">
      <h4 className=" text-2xl font-medium mb-2  text-red-950">Likes</h4>
      <button
